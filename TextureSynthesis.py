...
class TextureSynthesis:
    def __init__(self, model, original_image, original_image2, interp, layer_weights, nSplits, layer_name='', image_name='', image_name2='', saveDir='.', iterations=1000):
        ...
        self.original_image2 = original_image2 # 256x256x3
        self.pooling_weights_path = 'subset_weights'
        self.RF_option = 'tile'
    ...
    def _get_gramian(self, interp, original_image=None, original_image2=None):
        if original_image is None:
            original_image = self.original_image
            original_image2 = self.original_image2
        self.sess.run(tf.initialize_all_variables())
        gramian1 = dict()
        gramian2 = dict()
        gramianDif = dict()
        gramian = dict() #this is the interpolated gramian
        interpNum = 0 #if you are iterating through interps, in case you don't want all layers to be the same
    ...
    def train(self, sampleIdx=1, loss='both', loss_criteria=1e5, spectral_weight=1e-4):
        ...
        for i in range(self.iterations):
            ...
            if i % SAVE_STEP == 0:
                ...
                filename = self.saveDir + "/{}_{}_{}_{}x{}_{}_smp{}_step_{}".format( self.image_name, str(self.interp), self.image_name2, self.nSpl, self.nSpl, self.layer_name, sampleIdx, i)
